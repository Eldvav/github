...
def check_win(clicked_row, clicked_col):
    ...
    # detecter victoire Inverse diagonale
    count = 0
    for i in range(3):
    ...
    if win is False:
        ...
        print(count)
        if count == 9:
            print("Match Nul ! Irrecevable !")

# fonction qui place les symboles au click
...
button_width = 10
button_height = 4
window_width = int(3 * button_width * 1.5)  
window_height = int(3 * button_height * 1.5)  
